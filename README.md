...
I usually run the `run.py` in Spyder IDE that supports section-based execution. After running the training loop, I can run the evaluation loop and visuliaze and evaluate the result.
